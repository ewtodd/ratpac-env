{
  ...
  inputs = {
    ...
    ratpac-src = {
      url = "github:rat-pac/ratpac-two/3.3.0";
      flake = false;
    };
    ratpac-sandk-src = {
      url = "github:sandK-31/ratpac-two";
      flake = false;
    };
  };
  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        ratpac-two-sandk = mkRatpac {
          version = "unstable";
          src = ratpac-sandk-src;
        };
      in
      {
        packages.default = ratpac-two;
        packages.ratpac-two = ratpac-two;
        packages.ratpac-two-sandk = ratpac-two-sandk;
      }
    );
}
